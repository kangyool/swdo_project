...
<body>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <form action="/user/update" method="post" onsubmit="return formCheck();" class="col-md-9 m-auto" role="form">
                <div class="row">
                    <div class="" style="width:10%; visibility: hidden"></div>
                    <div class="form-group col-md-6 mb-3" style="width:75%">
                        <label for="inputid">아이디</label>
                        <input type="text" class="form-control mt-1" id="user_id" name="user_id" value="${detail.user_id }" readonly="readonly">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-3" style="width:75%">
                        ...
                        <input type="text" class="form-control mt-1" id="user_pw" name="user_pw" placeholder="비밀번호">
                    </div>
                    <div class="" style="width:10%;visibility: hidden"></div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-3" style="width:75%">
                        ...
                        <input type="text" class="form-control mt-1" id="user_pwCheck" name="user_pwCheck" placeholder="비밀번호 확인">
                    </div>
                    <div class="" style="width:10%;visibility: hidden"></div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-3" style="width:75%">
                        ...
                        <input type="text" class="form-control mt-1" id="user_name" name="user_name" value="${detail.user_name }">
                    </div>
                    <div class="" style="width:10%;visibility: hidden"></div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-3 cc-display-flex" style="width:75%;margin-top:10px">
                        <button type="submit" class="btn btn-success px-3" style="width:50%;margin-right: 1px">수정</button>
                        <input type="button" class="btn btn-success px-3" value="회원 탈퇴" onclick="userDelete('${detail.user_id }')" style="width:50%;margin-left: 1px">
                    </div>
                    <div class="" style="width:10%;visibility: hidden"></div>
                </div>
    ...
    <input type="hidden" id="cnt_str" value="${cnt_str }">
